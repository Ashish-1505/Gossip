...
import { Box, Button, Tooltip,Text, Menu, MenuButton, MenuList, Avatar, MenuItem, MenuDivider, Input,  useToast, Spinner, effect } from '@chakra-ui/react'
  ...
  return (
    <>
      <Box
        ...
        <Text fontSize="2xl" fontFamily="Work sans">Gossip</Text>
        <div>
            <Menu>
                <MenuButton p={1}>
                  <NotificationBadge
